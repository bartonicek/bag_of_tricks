...
mtext('(probability of winning a match)', 1, line = 3, family = 'serif')
mtext('Probability density', 2, line = 1, family = 'serif', las = 0)
mtext("Player's ability as probability\nof winning a match", 3, 
...
mtext("Random samples given\nplayer's ability", 3, line = 1, 
...
Clearly, the best choice is to bet that the tennis player is going to win 7 matches, as it has the highest expected outcome of \$20.50 (or, if I feel a bit more conservative, I can bet 6 matches which have almost the same expected outcome with \$20.40).
...
mtext('Probability density', 3, line = 1, family = 'serif', 
      font = 2, cex = 1.5)
box(col = col_fade)
...
mtext('x', 1, line = 2, family = 'serif')
mtext('Count', 2, line = 2.5, family = 'serif', las = 0)
mtext('Random samples', 3, line = 1, family = 'serif', 
      font = 2, cex = 1.5)
box(col = col_fade)
par(mfrow = c(1, 1))
